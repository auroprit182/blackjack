...
def compare(user_score, computer_score):
    if user_score == computer_score:
        ...
        return "You lose , opponent hit jackpot"
    elif user_score == 0:
        return "You win , you hit a blackjack"
    elif user_score > 21:
        return "You lose , you went over"
    elif computer_score > 21:
        return " You win , opponent went over"
    elif max(user_score, computer_score) == user_score:
        return " You win :) "
    else:
        return " You lose :( "
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f" Your cards: {user_cards} , current user score: {user_score}")
        ...
        if user_score == 0 or user_score > 21 or computer_score == 0:
            ...
            user_should_deal = input(" Type 'y' to get another card or press 'n' to pass: ")
